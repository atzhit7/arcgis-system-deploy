...
resource "aws_s3_bucket_object" "ansible_inventory" {
  ...
  key        = "env:/${terraform.workspace}/${data.terraform_remote_state.infra.outputs.green_domain_name}-ansible/inventory"
...
resource "aws_s3_bucket_object" "ansible_variables" {
  depends_on = [local_file.ansible_variables]
  bucket     = data.aws_s3_bucket.system_config.id
  key        = "env:/${terraform.workspace}/${data.terraform_remote_state.infra.outputs.green_domain_name}-ansible/vars_global.yaml"
...
#   bucket = data.aws_s3_bucket.system_config.id
#   key    = "env:/${terraform.workspace}/${data.terraform_remote_state.infra.outputs.green_domain_name}-arcgis/createportal.properties"
...
#   bucket = data.aws_s3_bucket.system_config.id
#   key    = "env:/${terraform.workspace}/${data.terraform_remote_state.infra.outputs.green_domain_name}/dev_createportal.properties"
...
#   name       = "/${var.name}/${terraform.workspace}-${data.terraform_remote_state.infra.outputs.green_domain_name}-ansible/inventory"
#   type       = "String"
#   value      = templatefile("../ansible/data/inventory.tmpl",
#     {
#       arcgisdatastorenode_private_dns = aws_instance.arcgisdatastore.private_dns
#       arcgisservernode_private_dns    = aws_instance.arcgisserver.private_dns
#       arcgisportalnode_private_dns    = aws_instance.arcgisportal.private_dns
...
# resource "aws_ssm_parameter" "ansible_variables" {
#   name       = "/${var.name}/${terraform.workspace}-${data.terraform_remote_state.infra.outputs.green_domain_name}-ansible/variables"
#   type       = "String"
#   value      = templatefile("../ansible/data/vars_global.tmpl",
#     {
#       arcgisdatastore_internal_dns = aws_route53_record.arcgisdatastore.name
#       arcgisserver_internal_dns    = aws_route53_record.arcgisserver.name
#       arcgisportal_internal_dns    = aws_route53_record.arcgisportal.name
...
resource "aws_ssm_parameter" "arcgisdatastore" {
  ...
  name       = "/${var.name}/${terraform.workspace}-${data.terraform_remote_state.infra.outputs.green_domain_name}-datastore/ec2-win-password"
  type       = "SecureString"
...
resource "aws_ssm_parameter" "arcgisserver" {
  ...
  name       = "/${var.name}/${terraform.workspace}-${data.terraform_remote_state.infra.outputs.green_domain_name}-server/ec2-win-password"
  type       = "SecureString"
...
resource "aws_ssm_parameter" "arcgisportal" {
  ...
  name       = "/${var.name}/${terraform.workspace}-${data.terraform_remote_state.infra.outputs.green_domain_name}-portal/ec2-win-password"
  type       = "SecureString"
